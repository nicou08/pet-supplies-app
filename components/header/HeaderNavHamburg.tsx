    ...
    <Drawer open={isOpen} onOpenChange={setIsOpen}>
      <div className="sm:hidden flex items-center px-3">
        <DrawerTrigger
          ...
          className="focus:outline-none w-11 h-11 rounded-full flex justify-center items-center shadow-none bg-transparent text-foreground hover:bg-accent data-[state=open]:bg-accent cursor-pointer transition-shadow duration-200"
        >
          <AlignJustify />
        </DrawerTrigger>
      </div>
